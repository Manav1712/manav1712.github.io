...
Over the past few years, I’ve bounced between labs, startups, and dev teams — writing code, shipping features, and learning _a ton_. For more information about my internships, check out my cv!
...
- At **Intellect Design**, I turned GPT-3.5 into a résumé reviewer — learned prompt engineering _and_ how to handle 1K+ users without breaking a sweat.
